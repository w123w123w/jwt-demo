package com.wulianfa.jwtdemo.Utils;
...
public class JwtTokenUtil {
    ...
    private String generateToken(Map<String, Object> claims) {
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS512, "wulianfa")
                .compact();
    }
     ...
     * @param username2 从数据库中查询出来的用户信息
     */
